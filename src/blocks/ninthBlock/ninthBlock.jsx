                    ...
                    <div className='flex items-center gap-[20px]'>
                        <div className='flex flex-col items-start gap-[20px]'>
                            ...
                            <p className='max-w-[330px] text-[14px] md:text-[16px]'>
                                The mix of a spacious, air-conditioned building with two
                                floors fully equipped for activities and games, and a
                                thoughtful outdoor area allows kids to{' '}
